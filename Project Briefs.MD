...
|무엇을 만들고자 하는가|  현대인은 위생과 청소의 중요성을 알지만, 바쁜 일정 속에서 관리하기 어려움.<br>
단순 알람이나 체크리스트 기능만 제공하는 기존의 청소 관련 서비스와 달리,<br>
AI 쓱싹비서는 사용자의 생활 패턴과 일정을 학습하고 날씨 데이터를 분석하여 최적의 청소 타이밍 및 위생 루틴을 제공함.<br>
이를 통해 사용자는 청소 계획에 대한 부담 없이 효율적으로 위생적인 생활공간을 유지하면서 본업에 집중할 수 있음. |
|고객| - 이름 : 김청소
- 나이 : 22세
- 직업 : 이화여자대학교 경영학과 3학년
- 거주 형태 : 신촌 원룸 자취(8평)
- 특징 : 수업, 과제, 대외활동, 알바 등 바쁜 스케줄로 인해 항상 시간이 부족하다고 느낌. 자취 1년차로 집안일에 익숙하지 않음.

김청소(22세, 이화여자대학교 경영학과 3학년)는 현재 8평 신촌 원룸에 1년째 거주 중이며 수업, 과제, 대외활동, 알바 등의 바쁜 일정으로 항상 시간이 부족하다고 느낀다.<br>
그로 인해 청소할 시간이 없어 미루다가 결국 몰아서 대청소를 하는 일이 잦다.<br>
뿐만 아니라 미세먼지 농도가 높은 날에 환기를 했다가 뒤늦게 알아채거나, 세탁한 날 저녁 비가 와 빨래가 충분히 마르지 않아 낭패를 본 적이 있다.<br>
김청소씨는 자투리 시간에 할 수 있는 간단한 청소 활동과, 기상 상황을 고려한 집안일의 알맞은 타이밍을 추천받아 매일 조금씩 자연스럽게 청소할 방법을 찾고 싶다.<br> |
|Pain Point| 1. 청소 습관 잡기의 어려움 - 스트레스, 시간 낭비
    1. 할일을 나눠서 하는 게 좋다는 것은 인지하고 있지만 막상 하려면 어떻게 나눠야 할지에 대한 기준이 명확하지 않고, 바빠서 미루다가 몰아서 하며 스트레스 받는 현대인들이 많음.
    2. 집안일에 익숙하지 않은 경우 청소 시간 분배를 잘 하지 못해 청소 시간이 비효율적으로 늘어나기도 함.
2. 맞춤형 청소 루틴 추천 서비스의 부재
    1. 매일 개인의 일정은 달라지는데 기존 청소 관련 서비스는 동일한 청소 할 일들을 추천해주는 데 그침. 즉 개인의 생활 패턴과 일정을 고려한 맞춤형 청소 루틴 추천 서비스가 필요함.
3. 날씨를 고려한 청소 루틴 추천 서비스의 부재
    1. 날씨에 따라 적절한 청소 방식이 달라지지만(예: 미세먼지 농도가 높은 날에는 환기 피해야 함, 비 오는 날에는 빨래 건조가 어려움) 기존 서비스들은 이를 고려하지 않음.
    2. 집안일에 익숙하지 않은 사람들은 청소할 때 기상 정보를 고려하는 것이 귀찮고 어려움. |
|기술 솔루션 서술| [Frontend]<br>
React - https://react.dev/<br>
TypeScript - https://www.typescriptlang.org/<br>
Tailwind CSS - https://tailwindcss.com/<br>
Zustand - https://zustand-demo.pmnd.rs/<br>
React Query - https://tanstack.com/query/latest<br><br>
[Backend]<br>
Spring Boot - https://spring.io/projects/spring-boot<br>
AWS EC2 - https://aws.amazon.com/ko/ec2/<br>
AWS S3 - https://aws.amazon.com/ko/s3/<br>
Docker - https://www.docker.com/<br>
MySQL - https://dev.mysql.com/<br><br>
[AI]<br>
PuLP - https://coin-or.github.io/pulp/<br>
Stable-Baselines3 - https://stable-baselines3.readthedocs.io/<br>
