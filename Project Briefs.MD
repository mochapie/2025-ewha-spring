...
|팀번호|프로젝트명|
|:---|:---|:---|:---|
|(#Team-[3] ##-Team-3-노페인-노게인)|청각 장애인을 위한 수어-텍스트-음성 변환 비대면 진료 서비스|
|(#Team-[4] ##-Team-4-이데댕김)|AI 기반 스마트 컨트랙트 취약점 분석 및 리포트 생성|
|(#Team-[6] ##-Team-6-닌자토끼)|회피형 성격 극복을 위한 맞춤형 습관 형성 서비스|
|(#Team-[7] ##-Team-7-우주정복-연구젝트)|[멀티모달  생성 AI] 멀티 모달리티 학습 환경에서 누락된 모달리티 데이터 생성 연구|
|(#Team-[8] ##-Team-8-드랍-더-8bit)|아이와 부모가 함께 동화를 만들어가는 인터랙티브한 방식의 AI 기반 동화 생성 프로그램|
|(#Team-[9] ##-Team-9-구르미)|뮤추얼클라우드 : HPC2-ML Scheduler|
|(#Team-[10] ##-Team-10-2ys)|Secure and Energy-Efficient Resource Optimization Framework for Real-time Task Execution in Industrial IoT|
|(#Team-[11] ##-Team-11-DevEwha)|컨테이너 기반 AI 워크플로우 파이프라인 최적화 (CI/CD, MLOps 관점)|
|(#Team-[12] ##-Team-12-내가그린)|클라우드 AI를 활용하여 사용자 데이터와 트래픽 분석을 통해 IT 환경 최적화를 목적으로 하는 프로그램|
|(#Team-[13] ##-Team-13-e시크)|멀티 모달 데이터 학습을 이용한 수요 예측도 향상|
|(#Team-[14] ##-Team-14-team329)|Overcoming Missing Modalities with Clustering: A Cross-Attention and Federated Learning Approach|
|(#Team-[15] ##-Team-15-GRAD)|일정 관리가 어려운 사람들을 위한 개인 맞춤 대학 생활 AI 비서|
|(#Team-[16] ##-Team-16-배꽃엔딩)|공공기관의 데이터와 AI를 활용해 제품의 규제 이력과 제조사 정보를 조회하고, 안전한 대체 제품을 추천하는 서비스|
|(#Team-[17] ##-Team-17-그린데빌)|연합 학습(Federated Learning) 환경에서 이질적인 데이터 학습을 통해 로컬에 특화된 학습 모델과 일반적인 추론을 위한 학습 모델 비교|
|(#Team-[18] ##-Team-18-코드만두(Code-만-Do!))|채용 데이터 분석과 자연어 처리 기술을 활용하여 이력서 문장을 최적화하고 구직자와 기업을 자동으로 연결해주는 AI 기반 채용 지원 플랫폼|
|(#Team-[19] ##-Team-19-T파니)|이미지 기반 상품 검색 및 추천|
|(#Team-[20] ##-Team-20-스카이화)|AI 기반 예술 작품 해설 서비스|
|(#Team-[21] ##-Team-21-투애니원)|BuddyEdu: 영유아를 위한 정서 지원 및 기초 교육 프로그램|
|(#Team-[22] ##-Team-22-큐리호스(Curihous))|초보 투자자가 AI 기반 자동매매를 활용하며 투자 원리를 학습하고 성장할 수 있는 맞춤형 퀀트 트레이딩 플랫폼|
|(#Team-[23] ##-Team-23-졸업하고싶조)|YagInfo|
|(#Team-[24] ##-Team-24-강배우)|AI 기반 여행 일정 추천 서비스|
|(#Team-[25] ##-Team-25-바위너구리)|개인 생활패턴과 날씨를 고려해 청소 & 위생 루틴을 추천하는 AI 서비스|
|(#Team-[27] ##-Team-27-AI-Persona)|AI 기반 실시간 성격 분석 프로그램|
|(#Team-[28] ##-Team-28-e스타트)|NLP와 오픈뱅킹 API를 활용한 20대의 과소비 방지를 위한 소비 패턴 분석 및 소비 습관 코칭 서비스|
